        ...
        <div class="stack gap-sm stacked-fields">
            ...
            <div class="grid wrap gap-sm" style="--grid-min: 30ch;">
                ...
                <div class="field">
                    ...
                    <div class="grow stack gap-xs">
                        <input type="number" min="0" name="hours_optional" value="{{ old('hours_optional', $library->hours_optional) }}" />
                ...
                <div class="field">
                    ...
                    <div class="grow stack gap-xs">
                        <input type="number" min="0" name="hours_complete" value="{{ old('hours_complete', $library->hours_complete) }}" />
